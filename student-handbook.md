...
**The core path gets you to a live URL with a working AI agent by 4:00.** Power Ups are for polishing and extending. Show & Tell is where you demo what you shipped.
...
Make sure you have your `TELEGRAM_BOT_TOKEN` and `TELEGRAM_CHAT_ID` from Day 1 handy — you'll need them in Step 3 for lead alerts.
...
3. Test that TELEGRAM_BOT_TOKEN + TELEGRAM_CHAT_ID can send a message
